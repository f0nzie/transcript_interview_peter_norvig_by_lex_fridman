...
### How has the book "Artificial intelligence: A modern approach" changed over the years
...
### Keeping human values in the utility function
...
**[Peter]** But we humans have figured that, right? 
...
### Education and the impact of online courses
...
**[Peter]** And then, there are certain things that just hard to do virtually, right? We're in a field where if you have your own computer, and your own papers, and so on, you can do the work anywhere. But if you're in a biology lab, or something, you know you don't have all the right stuff at home.
...
**[Peter]** Yeah. I think as people that's what we love to do. I was at a showing of "Her", where we had a panel discussion and somebody asked me "what other movie do you think Her similar to?" And my answer was ["Life of Brian"](), which is not a science fiction movie but both movies are about wanting to believe in something that's not necessarily real.
